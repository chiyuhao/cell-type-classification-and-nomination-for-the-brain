...
library(dplyr)
set.seed(3456)
file_path_root = "/root/datasets/humanMTG/"
...
saveRDS(query_seurat, paste0(file_path_root,"singleR_result.rds"))
#######################################
##### scmap sample usage ######
#######################################
...
saveRDS(query_seurat, paste0(file_path_root,"scmap_result.rds"))
...
saveRDS(query_seurat, paste0(file_path_root,"singleCellNet_result.rds"))
...
saveRDS(query_seurat, paste0(file_path_root,"CHETAH_result.rds"))