...
#seurat
if(file.exists(paste0(file_path_root,"data1/seurat_result_5.csv"))){
result_1 = read.csv(paste0(file_path_root,"data1/seurat_result_5.csv"),row.names=1)
result_2 = read.csv(paste0(file_path_root,"data2/seurat_result_5.csv"),row.names=1)
